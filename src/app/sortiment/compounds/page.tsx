...
export default function CompoundsPage() {
  const compounds = products.filter(
    (product) =>
      product.category === "compound" ||
      ...
      <section className="pt-4 pb-0 sm:pt-4">
        <div className="max-w-[1440px] mx-auto px-2.5 sm:px-4 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            Riakeo erbjuder exklusiva compounds – kraftfulla fyrverkeripjäser för den som vill ha en imponerande och professionell fyrverkerishow. Våra compounds är designade för att leverera maximal effekt med en enda tändning.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1440px] mx-auto px-2.5 sm:px-4 lg:px-8 space-y-6">
          <div className="flex flex-row flex-wrap items-center justify-between gap-3 border-y border-gray-100 py-3">
            <p className="text-sm text-gray-600">
              {compounds.length} produkter
            </p>
            <div className="flex items-center gap-2 whitespace-nowrap">
              <label htmlFor="compounds-sort" className="text-sm text-gray-600">
                Sortera
              </label>
              <select
                id="compounds-sort"
